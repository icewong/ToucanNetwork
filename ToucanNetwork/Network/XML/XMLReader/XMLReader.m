...
+(NSDictionary *)parserToDictionary:(NSXMLParser *)parser error:(NSError **)error{
    XMLReader *reader = [[XMLReader alloc] initWithError:error];
    NSDictionary *rootDict = [reader ParserToDictionary:parser options:0];
    return rootDict;
}
...
- (NSDictionary *)ParserToDictionary:(NSXMLParser *)data options:(XMLReaderOptions)options
{
